...
async function main(){
    ...
    // var o1 = await orderf.addorders("5e7d0cfb1695ef3f2c26bb50" , "mask" , 2 , "instant noodle" , 1);
    // var o2 = await orderf.addorders("5e7d0cfb1695ef3f2c26bb50" , "water" , 1 , "coke" , 2);
    ...
    var orders = await orderf.getbyuser("5e7d0cfb1695ef3f2c26bb50");
    console.log(orders);
